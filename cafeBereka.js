...
const kalidNatural = new Producto('6', 'El Kalid Natural', 'Nayarit', 'Finca El Kalid', 'Gerardo Vazquez', 1200, 'mezcla', 1200, 2, 'DSC_4743.jpg',  ' ' )
const kalidLavado = new Producto('7', "El Kalid Lavado", "Nayarit",  "Finca El Kalid", "Gerardo Vazquez", 1300, "Típica y Bourbon", 1000, 2, 'DSC_5295~3.jpg', "Este espectacular café es producto de un proceso de fermentación a bajas temperaturas, con un aroma a cáscara de mandarina y té de azahar y jazmín, un dulzor mieloso, y una ácidez balanceada, con un retrogusto a mandarina. Tiene un cuerpo sedoso y es excelente para cualquier método.", 'lavado' )
